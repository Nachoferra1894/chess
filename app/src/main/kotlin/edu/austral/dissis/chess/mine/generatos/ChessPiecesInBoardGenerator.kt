...
class ChessPiecesInBoardGenerator: PiecesInBoardGenerator {
    ...
    fun addCommonPieces(cols: Int,row: Int,pieceSet: MutableList<Piece>):  MutableList<Piece>{
    ...
    fun addPawns(cols: Int,row: Int,pieceSet: MutableList<Piece>): MutableList<Piece> {
        for (i in 0 until cols ){
            val movePiece = pieceSet.find {
